...
RUN curl -L > 'installbuilder.run' "https://releases.installbuilder.com/installbuilder/installbuilder-professional-24.3.0-linux-x64-installer.run" \
&& chmod 755 installbuilder.run && ./installbuilder.run --mode unattended --prefix /opt/installbuilder \
&& rm installbuilder.run && ln -sf /opt/installbuilder /root/installbuilder-24.3.0
